package br.com.secretariadeeducacao.apiescolasecretariadeeducacao.user.config;
...
import br.com.secretariadeeducacao.apiescolasecretariadeeducacao.user.service.AutenticacaoService;
...
public class SecurityConfigurations extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests().antMatchers(HttpMethod.GET, "/v1/escola").permitAll()
				.antMatchers(HttpMethod.GET, "/v1/escola/{escolaId}").permitAll()
				.antMatchers(HttpMethod.GET, "/v1/escola/{escolaId}/turma").permitAll()
				.antMatchers(HttpMethod.GET, "/v1/escola/{escolaId}/turma/{turmaId}").permitAll()
